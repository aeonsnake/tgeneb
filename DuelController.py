...
class DuelController:
    ...
    def tick(self):
        ...
        p1_sentLines = self.linesToSend(self.p1_controller.streak,
                                        self.p1_controller.linesCleared - self.p1_linesCleared)
        ...
        p2_sentLines = self.linesToSend(self.p2_controller.streak,
                                        self.p2_controller.linesCleared - self.p2_linesCleared)
